"""② 供应商寻源 Agent：OneBound 1688 搜索 + LLM 评估推荐。"""

from ..connectors.llm import get_llm
from ..connectors.onebound_client import search_1688
...
def sourcing_node(state: PipelineState) -> dict:
    ...
    items = search_1688(keyword_cn)[:15]
    offers = [
        SupplierOffer(
